...
SECRET_KEY = 'django-insecure-go12%eu2f_usolaku!34+f%^z9v6lba3gs3hq8i3@e#br0b$yp'
...
#traverse if the FileSystemFinder finder is enabled, for example, if you
#use the collectstatic or findstatic management command or
